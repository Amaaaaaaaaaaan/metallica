  ...
  return (
    ...
    <motion.div
      ...
      style={{
        ...
        height: 5,
        transformOrigin: "0%",
        backgroundColor: "var(--hue-1, #008080)",
        zIndex: 1000,
      }}
    />
    <Sidenav />
    <div ref={wrapperRef} className={styles.wrapper} style={{ overflowY: 'scroll', height: '100vh' }}>x
      ...
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerIcons}>
          ...
          {/* Phone Link (You can keep or remove "tel:" links depending on your preference) */}
          <a
