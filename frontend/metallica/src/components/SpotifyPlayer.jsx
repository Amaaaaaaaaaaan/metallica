...
const SpotifyPlayer = ({ track, onFinalSave, onDiscard, onClose }) => {
  ...
  // Setup audio event listeners (for duration, progress, etc.)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // Force-check duration after a short delay
    setTimeout(() => {
      if (isNaN(audio.duration) || !isFinite(audio.duration)) {
        audio.load();
      }
    ...
    <>
      {track?.dataUrl && (
        <div className={styles.playerContainer}>
          ...
          {/* Right Section: Volume Controls and Save/Discard */}
      ...
      {showSaveDialog && track?.dataUrl && (
        <SaveRecordingDialog
          recordingUrl={track.dataUrl}
